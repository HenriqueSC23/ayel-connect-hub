...
export const users: User[] = [
  ...
  },
  {
    ...
    email: "carlos.oliveira@tga.com.br",
    phone: "(31) 3222-0000",
    password: "123456",
...
export const companies: Company[] = [
  ...
  },
  {
    id: "c3",
    nome: "Condoshop",
    cnpj: "45.987.654/0001-20",
    logo: "/src/assets/condoshop-logo.png",
    brandColor: "#2563EB",
    createdAt: new Date().toISOString(),
  },
  {
    id: "c4",
    nome: "Pagelev",
    cnpj: "21.654.987/0001-30",
    logo: "/src/assets/page-lev-logo.png",
    brandColor: "#16A34A",
    createdAt: new Date().toISOString(),
  },
  {
    id: "c5",
    nome: "Rede",
    cnpj: "78.321.654/0001-40",
    logo: "/src/assets/rede-logo.png",
    brandColor: "#0F172A",
    createdAt: new Date().toISOString(),
  },
];
...
export const posts: Post[] = [
  {
    ...
    content: "Estamos felizes em apresentar a nova TGA Intranet! Aqui você encontra informações importantes em um só lugar.",
...
export const trainings: Training[] = [
  ...
  },
  {
    ...
    shortDescription: "Fluxos para instalação segura dos equipamentos TGA.",
  ...
  },
  {
    ...
    category: "suporte",
    content: "Procedimentos de troubleshooting, scripts de comunicação e fluxos de escalonamento para equipes de suporte TGA.",
    companyId: "c2",
    createdAt: new Date().toISOString(),
  },
];
